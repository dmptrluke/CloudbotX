...
class CommandHook(Hook):
    ...
    def __init__(self, plugin, cmd_hook):
        """
        :type plugin: str
        :type cmd_hook: obrbot.hook._CommandHook
        """
...
class RegexHook(Hook):
    ...
    def __init__(self, plugin, regex_hook):
        """
        :type plugin: Plugin
        :type regex_hook: obrbot.hook._RegexHook
        """
...
class RawHook(Hook):
    ...
    def __init__(self, plugin, irc_raw_hook):
        """
        :type plugin: Plugin
        :type irc_raw_hook: obrbot.hook._RawHook
        """
...
class EventHook(Hook):
    ...
    def __init__(self, plugin, event_hook):
        """
        :type plugin: Plugin
        :type event_hook: obrbot.hook._EventHook
        """
